...
const float MIN_MAINTAIN_DEPTH = .5;
const float MAX_MAINTAIN_DEPTH = 1.5;
const float MIN_TOLERANCE = .5;
...
const unsigned long DATA_SEND_DELAY = 20000; // 3 sec data send delay
