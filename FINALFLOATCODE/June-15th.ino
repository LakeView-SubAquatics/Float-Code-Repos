...
const int MAX_MAINTAINS = 12;
// Modifiy these data sets  for what depth to maintain
const float MIN_MAINTAIN_DEPTH = 0.5;
const float MAX_MAINTAIN_DEPTH = 1;
...
const unsigned long SEND_INTERVAL = 1000; // 1 second between data points
...
// Psi Rate of Change
const float PSI_ROC = 0.03;
const float MAX_PSI_ROC = 0.04;
const float PSI_ROC_FLIP = 0.04;
const float TOLERABLE_DEPTH = 0.05;
